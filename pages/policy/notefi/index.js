import NoteFi from '../../../components/NoteFi';
	...
	return (
		<div className="container w-11/12 m-auto">
			...
			<div className="w-1/2 m-auto">
				...
				<p>
					Holoni built the NoteFi app as a Free app. This SERVICE is provided by
					Holoni at no cost and is intended for use as is.
				</p>{' '}
				<p>
				...
				<p>
					...
					Terms and Conditions, which are accessible at NoteFi unless otherwise
				...
				<p>This policy is effective as of 2022-08-16</p>{' '}
				<p>
					<strong>Contact Us</strong>
				</p>{' '}
				<p>
					If you have any questions or suggestions about my Privacy Policy, do
					not hesitate to contact me at cs.holoni@gmail.com.
				</p>{' '}
				<p>
